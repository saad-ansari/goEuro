...
@interface BusViewController ()<RequestDelegate,LGRefreshViewDelegate>
{
...
- (void)viewDidLoad
{
    ...
    if ([SWDefaults busArray].count > 0)
    {
        [self populateOfferData:[SWDefaults busArray]];
    }
...
-(void)callOfferData
{
    if([self isConnectionAvailable])
    {
        ...
        [httpManager callGetService:self withName:@"37yzm"];
    }
    else
    {
